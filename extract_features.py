...
net_name = 'vaegan'
logits_name = 'vaegan/generator/encoder/fc6'
ck_path = 'G:\\models\\vaegan\\model.ckpt-828'
...
dataset_dir = 'G:\\'
abnormal_label = 'synthetic_data/label.txt'
normal_label = 'G:\\label.txt'
...
class FeatureExtractor(object):
  ...
  def __init__(self, network_name, checkpoint_path, batch_size, image_size=None):
    ...
    # 检索返回logits和端点的函数 (for extracting activations)

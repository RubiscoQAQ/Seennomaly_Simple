...
def video():
  for root, dirs, files in os.walk('G:\\videotest\\videos'):
    for name in files:
      ...
      with open(os.path.join('G:\\videotest', 'label.txt'), 'a') as label_file:
